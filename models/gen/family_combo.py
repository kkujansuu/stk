...
RETURN extract(x IN relationships | 
    ...
    def get_family_events(self):
        ...
        raise (
            NotImplementedError,
            "models.gen.family_combo.Family_combo.find_family_for_event poistettu 17.5.2020",
        )
    ...
    def get_family_data_by_id(self):
        ...
        raise (
            NotImplementedError,
            "models.gen.family_combo.Family_combo.get_family_data_by_id poistettu 17.5.2020",
        )
    ...
    @staticmethod
    def get_family_data(
        uuid, context: UserContext
    ):  # -> bl.family.FamilyReader.get_family_data
                        ...
                        for event_node, place_node in record["family_event"]:
                            if event_node:
                                ...
                                if place_node:
                                    ...
                                    res = session.run(
                                        Cypher_person.get_places, uid_list=[e.uniq_id]
                                    )
                                    for rec in res:
                                        ...
                                        if rec["pi"]:
                                            ...
                                            pl_in.names = place_names_local_from_nodes(
                                                rec["pinames"]
                                            )
    ...
    def set_dates_sortnames(tx, uniq_id, dates, father_sortname, mother_sortname):
        ...
        return tx.run(Cypher_family.set_dates_sortname, id=uniq_id, f_attr=f_attr)
