...
class Transformer:
    ...
    def transform_items(self, items, path="", phase=1):
        ...
        for item in items:
            ...
            item.children = self.transform_items(
                item.children, path=item.path, phase=phase
            )
...
if __name__ == "__main__":
    ...
    transformer = Transformer(
        transform_callback=transform, options=options, display_callback=display
    )
