...
class ExtendedLoginForm(LoginForm):
    ...
    email = StringField(
        _l("Email or Username"), validators=[Required("Email required")]
    )
    password = PasswordField(_l("Password"), validators=[Required("Password required")])
...
class ExtendedConfirmRegisterForm(ConfirmRegisterForm):
    ...
    agree = BooleanField(
        LazyFormat(
            "I have read and agree to the <a href='{terms_of_use_url}' target='esite'>{terms_of_use}</a>",
